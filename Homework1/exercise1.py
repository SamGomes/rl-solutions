...
class EpsilonGreedy(ValueBasedAlg): 
	def __init__(self,initialReward,numberOfSimSteps,numOfPossibleActions, currRunsRewards, numberOfSims , epsilon):
		ValueBasedAlg.__init__(self, initialReward, numberOfSimSteps, numOfPossibleActions, currRunsRewards, numberOfSims)
...
def main():
	...
	algorithmsToTest.append(EpsilonGreedy(0, numberOfStepsPerSim, numOfPossibleActions, currRunAlgRewards[0], numberOfSims, 0.0))
	algorithmsToTest.append(EpsilonGreedy(5.0, numberOfStepsPerSim, numOfPossibleActions, currRunAlgRewards[1], numberOfSims, 0.0))
	
	algorithmsToTest.append(EpsilonGreedy(0, numberOfStepsPerSim, numOfPossibleActions, currRunAlgRewards[3], numberOfSims, 0.1))
	algorithmsToTest.append(EpsilonGreedy(0, numberOfStepsPerSim, numOfPossibleActions, currRunAlgRewards[2], numberOfSims, 0.01))
	...
	plt.plot(steps, currRunAlgRewards[1], color='darkviolet', marker='', linestyle='-', label=r'$\epsilon=0 (optimistic\ greedy)$')
